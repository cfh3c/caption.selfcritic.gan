...
def parse_opt():
    ...
    parser.add_argument('--start_from', type=str, default='experiment/20171104_160559/',#'save/att2in/',
    ...
    # Model settings
    parser.add_argument('--caption_model', type=str, default="att2in",
    ...
    parser.add_argument('--learning_rate', type=float, default=4e-4, #default = 4e-4
                    help='learning rate')
